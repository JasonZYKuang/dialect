...
angular.module('starter', ['ionic', 'ngCordova', 'starter.controllers', 'starter.nav', 'starter.services'])
  .value("YuyinLang", {id: "YANGJIANG", name: "阳江话"})
  ...
  .run(function ($ionicPlatform, $rootScope, $window, $document, DeviceStatus, TranslateService,langlist) {
